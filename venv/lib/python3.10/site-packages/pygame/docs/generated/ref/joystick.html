...
<a class="reference internal image-reference" href="../_images/joystick_calls.png"><img alt="joystick module example" src="../_images/joystick_calls.png" style="width: 363.0px; height: 397.0px;" /></a>
<figcaption>
...
between pygame 1 and pygame 2. Below are a couple of mappings for two popular game pads.</p>
