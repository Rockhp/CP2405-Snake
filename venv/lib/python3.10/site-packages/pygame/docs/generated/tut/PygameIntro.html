...
<html>
  <head>
    ...
    <title>Pygame Intro &#8212; pygame v2.1.2 documentation</title>
...
<span class="linenos">13</span><span class="k">while</span> <span class="mi">1</span><span class="p">:</span>
...
<tr class="row-odd"><td><p><a class="reference internal" href="../ref/image.html#module-pygame.image" title="pygame.image: pygame module for image transfer"><code class="xref py py-mod docutils literal notranslate"><span class="pre">image</span></code></a></p></td>
