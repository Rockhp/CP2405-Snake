...
<html>
  <head>
    ...
    <title>Class Color API exported by pygame.color &#8212; pygame v2.1.2 documentation</title>
    ...
    <link rel="prev" title="API exported by pygame.cdrom" href="cdrom.html" /> 
  </head><body>  
...
<h2>src_c/color.c<a class="headerlink" href="#src-c-color-c" title="Permalink to this headline">¶</a></h2>
