...
<html>
  <head>
    ...
    <title>API exported by pygame.display &#8212; pygame v2.1.2 documentation</title>
...
<h2>src_c/display.c<a class="headerlink" href="#src-c-display-c" title="Permalink to this headline">¶</a></h2>
...
The object returned by <code class="xref py py-func docutils literal notranslate"><span class="pre">pgyame.display.Info()</span></code>.</p>
</dd></dl>
